...
def nwr_strategy(
    ...
    new_work_registration = Nwr(record_prefix)

    """
    [Mandatory] Name/Title of the work. 
    """
    work_title = line[19:79].strip()
    new_work_registration.work_title = work_title
    ...
    new_work_registration.language_code = language_code
    ...
    new_work_registration.submitter_work = submitter_work
    ...
    new_work_registration.musical_work_distribution = musical_work_distribution

    """
    [Optional] Original copyright number of the work.
    """
    category_duration = line[129:135].strip()
    new_work_registration.category_duration = category_duration

    """
    [Mandatory] Indicates whether or not the work has ever been recorded.
    """
    recorded_indicator = line[135:136].strip()
    new_work_registration.recorded_indicator = recorded_indicator
    ...
    new_work_registration.text_music_relationship = text_music_relationship
    ...
    new_work_registration.relationship_composite_type = relationship_composite_type
    ...
    new_work_registration.version_type = version_type
    ...
    new_work_registration.excerpt_type = excerpt_type
    ...
    Arrangement Table.
    """
    if new_work_registration.version_type == "MOD":
        music_arrangement = line[148:151].strip()
        new_work_registration.music_arrangement = music_arrangement
    ...
    if new_work_registration.version_type == "MOD":
        ...
        new_work_registration.lyric_adaptation = lyric_adaptation
    ...
    new_work_registration.contact_name = contact_name
    ...
    new_work_registration.contact_id = contact_id

    """
    [Optional] These values reside in the CWR Work Type table.
    """
    cwr_work_type = line[194:196].strip()
    new_work_registration.cwr_work_type = cwr_work_type
    ...
    new_work_registration.grand_rights_ind = grand_rights_ind
    ...
    """
    if new_work_registration.relationship_composite_type:
        composite_component_count = line[200:208].strip()
        new_work_registration.composite_component_count = composite_component_count
    ...
    new_work_registration.date_of_publication_of_printed_edition = (
    ...
    new_work_registration.exceptional_clause = exceptional_clause
    ...
    new_work_registration.opus_number = opus_number
    ...
    new_work_registration.catalogue_number = catalogue_number
    ...
    new_work_registration.priority_flag = priority_flag

    # pprint.pprint(new_work_registration.asdict())

    return new_work_registration
